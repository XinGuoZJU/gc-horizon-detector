...
if __name__ == '__main__':
    org_path = '/n/fs/vl/xg5/workspace/baseline/gc_horizon_detector/dataset/YUD/data/data.json'
    save_path = '/n/fs/vl/xg5/workspace/baseline/gc_horizon_detector/dataset/YUD/viz_line'
