...
def run(dataset_name, idx, save_op):
    ...
    data_path = '/n/fs/vl/xg5/workspace/baseline/gc_horizon_detector/dataset/' \
                                                        + dataset_name + '/output'
    error_file = '/n/fs/vl/xg5/workspace/baseline/gc_horizon_detector/logs/' \
